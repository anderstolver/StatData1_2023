...
Dette eksempel er et supplement til indholdet på forelæsningsslides fra d. 4/10-2023.
...
Som beskrevet på slides 14-15 fra forelæsning d. 25/9-2023 (og i lærebogens Ch. 6.4), så kan vi teste hypotesen $H_0: \beta_1 = 1, \beta_2 = 2$ ved at fortage en sammenligne (med `anova()`) af
