---
title: 'StatData1: forelæsning d. 6/9-2023'
...
Datasættet `antibio` beskrevet på dagens forelæsningsslides (6/9-2023) indeholder målinger af mængden af organisk materiale (`org`) i gødning fra 36 kvier, som er inddelt i seks grupper (`type`). Grupperne angiver hvilken type antibiotikum, som har været tilsat til kviernes foder. Gruppen `type = Control` angiver, at der ikke har været tilsat antibiotikum til foderet.
