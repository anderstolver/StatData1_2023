...
* Målinger af **afstand mellem to punkter** indsamlet på baggrund af studerende på StatData1 i 2023 (formål var at *ramme* en afstand på 8 cm).
...
Vi indlæser datasættet indsamlet ved forelæsningen d. 11/9-2023
...
```{r}
my_data <- read.table("../data/gaet8_2023.txt", header = T)
head(my_data)
```
...
Vi laver et histogram og et QQ-plot som vi lærte ved forelæsningen d. 11/9-2023.
